...
const QuertyKeyboard = ({ setActiveType, setSearch }: any) => {
    ...
    const keyClass =
        ...
        "hover:bg-[#f2f2f2] " +
        "active:translate-y-[2px] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] " +
    ...
    return (
        <div className="h-[28vh] p-2 rounded-2xl bg-[#d1d5db]">
            ...
            <div className="grid grid-cols-10 gap-2">
                ...
                <Button
                    icon={<RiSpace />}
                    className={classNames(keyClass, "col-span-3")}
                    onMouseDown={(e) => {
                        e.preventDefault();
                        onWriteSymbol(" ");
                    }}
