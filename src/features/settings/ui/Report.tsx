...
const Report = ({ item, telegramBotConfig }: any) => {
    ...
    const onSubmitNumiberData = async () => {
        ...
        if (invalidIndex !== -1) {
            setErrorState(true);
            showErrorLocalMessage(
                `Неверный номер в строке ${invalidIndex + 1}`,
            );
            return;
        }
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-end gap-x-2 mt-5">
                        {item?.token ? (
                            <>
                                {checkPermission(
                                    AccountPermissions.AccountPermissionTelegramBotDelete,
                                ) && (
                                    <CommonDeleteDialog
                                        children={
                                            <Button
                                ...
                                {checkPermission(
                                    AccountPermissions.AccountPermissionTelegramBotUpdate,
                                ) && (
                                    <Button
                            ...
                            <>
                                {checkPermission(
                                    AccountPermissions.AccountPermissionTelegramBotCreate,
                                ) && (
                                    <Button
