...
const PurchaseTable = ({
  ...
  const product = useMemo(() => {
    return products?.find((p: any) => p.productId === currentItem?.productId);
  }, [products, currentItem?.productId]);

  const retailPrice = useMemo(() => {
    return product?.prices?.find((p: any) => p?.product_price_type?.is_primary);
  }, [product]);
  ...
  return (
    <div className="overflow-hidden h-[81vh] mb-3 rounded-2xl">
      <div className="border-2 border-slate-200 overflow-y-auto rounded-t-2xl h-[65.3vh]">
                  ...
                  return (
                    <Tr
                      ...
                      className={classNames(
                        ...
                        expandedRow?.toString() === row.id && "text-green-600",
          ...
          <div className="w-full sticky bottom-0 bg-white border-t border-slate-200">
            <div className="flex items-center justify-between gap-x-2">
              <div className="flex justify-end gap-x-2 items-center px-2 py-2.5">
                ...
                <div
                  className={classNames("text-sm font-semibold text-green-600")}
                >
            ...
            >
              {isEditing?.isOpen && isEditing?.type === "price" ? (
                ...
                >
                  <span className="text-xs font-normal">Цена:</span>
        ...
        <div className="grid grid-cols-3 gap-x-1 items-center mb-4">
          ...
          <Input
            ...
            onChange={(val) => {
              ...
              const priceId =
                selectedType === 1 ? retailPrice?.id : bulkPrice?.id;
