...
export interface InputProps extends CommonProps, Omit<InputHTMLAttributes<HTMLInputElement | HTMLTextAreaElement>, 'size' | 'prefix' | 'value'> {
...
const Input = (props: InputProps) => {
    ...
    const fixControlledValue = (val: string | number | readonly string[] | undefined | null) => {
